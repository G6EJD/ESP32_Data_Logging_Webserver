/* ESP8266 plus DHT-22 Sensor with a Temperature and Humidity Web Server
 *  
...
// Setup DHT22
#include <Adafruit_Sensor.h>   // Install Adafruit TinyDHT via Sketch, Include Library, Manage Libraries
#include <DHT.h>
#include <DHT_U.h>
